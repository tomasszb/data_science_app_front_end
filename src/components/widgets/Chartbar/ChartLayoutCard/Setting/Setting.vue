...
<script>
    ...
    import CoordinatesPicker from './CoordinatesPicker/CoordinatesPicker'
    ...
    export default {
        ...
        components: {
            ColorPicker, CoordinatesPicker, BorderPicker, TextPicker, FontPicker, StylePicker, SizePicker
        }
    }
</script>
