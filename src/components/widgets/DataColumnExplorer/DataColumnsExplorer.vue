...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateFilterObject() {
                let Element = Object.assign({}, this.projectObjects[this.activeElement]);
            ...
            updateSortObject() {
                let Element = Object.assign({}, this.projectObjects[this.activeElement]);
                let outputSortID = this.projectObjects[this.activeElement].parameters['output_sort_id'];
                let Sort = {};
            ...
            refreshTable() {
                this.tableKey=this.activeElement+'-table-with-data'
            }
        },
        computed: {
            ...mapState('proj', [
            ...
            tableIndexName() {
                return this.activeElement + "-run" + JSON.stringify(this.filterKwargs) + "-" + JSON.stringify(this.sortKwargs)
            }
        },
        created() {
            this.requestTable()
